...
{
 cout<<rollno<<setw(6)<<" "<<name<<setw(10)<<marks1<<setw(4)<<marks2<<setw(4)<<marks3<<setw(4)//to the set width using setw()
 <<marks4<<setw(4)<<marks5<<setw(8)<<per<<setw(6)<<grade<<endl;
}
...
void class_result()
{
 ...
 cout<<"\n\n\t\tALL STUDENTS RESULT \n\n";
 cout<<"==========================================================\n";
 cout<<"R.No    Name              Marks         %age     Grade"<<endl;
